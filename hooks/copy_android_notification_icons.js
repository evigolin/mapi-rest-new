...
var files = [{
  'resources/android/notification/drawable-hdpi-icon.png':
     path.join(rootDest, 'drawable-hdpi/ic_stat_onesignal_default.png')
}, {
  'resources/android/notification/drawable-mdpi-icon.png':
    path.join(rootDest, 'drawable-mdpi/ic_stat_onesignal_default.png')
}, {
  'resources/android/notification/drawable-xhdpi-icon.png':
    path.join(rootDest, 'drawable-xhdpi/ic_stat_onesignal_default.png')
}, {
  'resources/android/notification/drawable-xxhdpi-icon.png':
    path.join(rootDest, 'drawable-xxhdpi/ic_stat_onesignal_default.png')
}, {
  'resources/android/notification/drawable-xxxhdpi-icon.png':
